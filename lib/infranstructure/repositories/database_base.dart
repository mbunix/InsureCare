const String DatabaseName = 'autoflexApp.store.db';

/// [autoflexDatabaseBase] defines an interface to be fulfilled so that a storage component
/// may work, for each exclusive platform. (Mobile and Web)
abstract class autoflexDatabaseBase<T> {
